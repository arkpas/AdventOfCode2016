...
<pre>
UWAGA: Program został dostosowany tylko do części drugiej zadania. Po wykonaniu części pierwszej zmodyfikowałem go
nie pozostawiając algorytmu, który ją rozwiązuje, gdyż nie był mi już potrzebny.
